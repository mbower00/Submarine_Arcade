...
![client-server connection visual showing the client of one computer connected to the server of the other computer and vice versa.]("master/assets/socket_visual.png")
